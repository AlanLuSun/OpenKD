...
def main():
    ...
    save_root = f'output/episode_images/shot{cfg.TEST.NUM_TEST_SHOT}+text{cfg.TEST.TEXT_PROMPT_SETTING.NUM_TEXT}/predictions-{get_dataset_type(cfg)}/base'
    eval_results = validate(cfg, openkd_model, test_episode_loader, num_test_episodes=1000, save_root=save_root)
    acc = eval_results[0]
    ...
    save_root = f'output/episode_images/shot{cfg.TEST.NUM_TEST_SHOT}+text{cfg.TEST.TEXT_PROMPT_SETTING.NUM_TEXT}/predictions-{get_dataset_type(cfg)}/novel'
    eval_results = validate(cfg, openkd_model, test_episode_loader2, num_test_episodes=1000, save_root=save_root)
    acc = eval_results[0]
