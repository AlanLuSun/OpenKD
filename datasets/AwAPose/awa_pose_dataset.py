...
def get_hflip():
    ...
    for pair_id in flip_pairs:
        type1 = keypoint_types[pair_id[0]]
        type2 = keypoint_types[pair_id[1]]
        hflip[type1] = type2
        hflip[type2] = type1
    return hflip
...
def predefined_auxiliary_paths():
    ...
    path1 = [
        ...
        [keypoint_types.index('nose'), keypoint_types.index('left_earbase')],
        # [keypoint_types.index('r_eye'), keypoint_types.index('r_ear')],
        # [keypoint_types.index('r_eye'), keypoint_types.index('nose')],
        [keypoint_types.index('nose'), keypoint_types.index('right_earbase')],
