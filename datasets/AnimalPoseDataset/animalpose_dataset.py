...
HFLIP = {
    ...
    'right-front leg': 'left-front leg',
    'left-back leg': 'right-back leg',
    'right-back leg': 'left-back leg',
    'left-front knee': 'right-front knee',
    'right-front knee': 'left-front knee',
    'left-back knee': 'right-back knee',
    'right-back knee': 'left-back knee',
    'left-front paw': 'right-front paw',
    'right-front paw': 'left-front paw',
    'left-back paw': 'right-back paw',
    'right-back paw': 'left-back paw'
}

# front-back symmetry
FBFLIP = {
    'left-front leg': 'left-back leg',
    'right-front leg': 'right-back leg',
    'left-back leg': 'left-front leg',
    'right-back leg': 'right-front leg',
    'left-front knee': 'left-back knee',
    'right-front knee': 'right-back knee',
    'left-back knee': 'left-front knee',
    'right-back knee': 'right-front knee',
    'left-front paw': 'left-back paw',
    'right-front paw': 'right-back paw',
    'left-back paw': 'left-front paw',
    'right-back paw': 'right-front paw'
}
...
DFLIP = {
    ...
    'left-back leg': 'right-front leg',
    'right-back leg': 'left-front leg',
    'left-front knee': 'right-back knee',
    'right-front knee': 'left-back knee',
    'left-back knee': 'right-front knee',
    'right-back knee': 'left-front knee',
    'left-front paw': 'right-back paw',
    'right-front paw': 'left-back paw',
    'left-back paw': 'right-front paw',
    'right-back paw': 'left-front paw'
}
...
def predefined_auxiliary_paths():
    ...
    # path1 = [
    #     [keypoint_types.index('nose'), keypoint_types.index('left ear')],
    #     [keypoint_types.index('nose'), keypoint_types.index('right ear')],
    #     [keypoint_types.index('left-front leg'), keypoint_types.index('left-front paw')],
    #     [keypoint_types.index('right-front leg'), keypoint_types.index('right-front paw')],
    #     [keypoint_types.index('left-back leg'), keypoint_types.index('left-back paw')],
    #     [keypoint_types.index('right-back leg'), keypoint_types.index('right-back paw')],
    # ]

    path1 = [
        # [keypoint_types.index('left eye'), keypoint_types.index('left ear')],
        # [keypoint_types.index('left eye'), keypoint_types.index('nose')],
        [keypoint_types.index('nose'), keypoint_types.index('left ear')],
        # [keypoint_types.index('right eye'), keypoint_types.index('right ear')],
        # [keypoint_types.index('right eye'), keypoint_types.index('nose')],
        [keypoint_types.index('nose'), keypoint_types.index('right ear')],
        ...
        # [keypoint_types.index('left-front leg'), keypoint_types.index('left-front knee')],
        # [keypoint_types.index('left-front knee'), keypoint_types.index('left-front paw')],
        [keypoint_types.index('left-front leg'), keypoint_types.index('left-front paw')],
        # [keypoint_types.index('right-front leg'), keypoint_types.index('right-front knee')],
        # [keypoint_types.index('right-front knee'), keypoint_types.index('right-front paw')],
        [keypoint_types.index('right-front leg'), keypoint_types.index('right-front paw')],
        # [keypoint_types.index('left-back leg'), keypoint_types.index('left-back knee')],
        # [keypoint_types.index('left-back knee'), keypoint_types.index('left-back paw')],
        [keypoint_types.index('left-back leg'), keypoint_types.index('left-back paw')],
        # [keypoint_types.index('right-back leg'), keypoint_types.index('right-back knee')],
        # [keypoint_types.index('right-back knee'), keypoint_types.index('right-back paw')],
        [keypoint_types.index('right-back leg'), keypoint_types.index('right-back paw')],
    ]
